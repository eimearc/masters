...
class SimpleTriangleBench {
    public:
    SimpleTriangleBench()=default;
    ~SimpleTriangleBench() noexcept
    {
        vkDeviceWaitIdle(device);
        cleanup();
    };

    SimpleTriangleBench(GLFWwindow *_window, size_t _)
    {
        window=_window;
        initVulkan();
    }
...
private:
    ...
    void createLogicalDevice() {
        ...
        std::set<uint32_t> uniqueQueueFamilies = {static_cast<uint32_t>(indices.graphicsFamily), static_cast<uint32_t>(indices.presentFamily)};
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("simple_triangle_vert.spv");
        auto fragShaderCode = readFile("simple_triangle_frag.spv");
    ...
    void createSyncObjects() {
        ...
        inFlightFences.resize(swapchainSize);
